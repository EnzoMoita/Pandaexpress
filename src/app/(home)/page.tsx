        ...
        <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm text-zinc-500 dark:text-zinc-400">
              Atualize sua fota e suas informações pessoais aqui.
            </span>
          </div>
      ...
      >
        ...
        <label className="grid gap-3 pt-5 lg:grid-cols-form">
          ...
          <Select.Root name="timezone">
            <Select.Trigger>
              <Select.Value placeholder="Selecione seu fuso horário..." />
            </Select.Trigger>
        ...
        <div className="grid gap-3 pt-5 lg:grid-cols-form">
          ...
          >
            Bio
            <span className="text-sm font-normal text-zinc-500 dark:text-zinc-400">
              Escreva breviamente sua biografia.
            </span>
          </label>
          <div className="flex flex-col gap-3">
            ...
            <Textarea
              name="bio"
              id="bio"
              defaultValue="Me chamo Enzo, dou DEV e amo games."
            />
          </div>
        </div>
